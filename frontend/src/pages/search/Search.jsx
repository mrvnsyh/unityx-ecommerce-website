...
const Search = () => {
    ...
    return (
        <>
            <section className='section__container' style={{background: 'var(--primary-color-light)'}}>
            ...
            <section className='section__container'>
                <div className='w-full mb-12 flex flex-col md:flex-row items-center justify-center gap-4'>
                    ...
                    className='search-button w-full md:w-auto py-2 px-8 bg-blue-700 text-white rounded hover:bg-[var(--primary-color)]'>Search</button>
                </div>
